...
export default function AdminDashboardPage() {
    ...
    const filteredCurations = curations.filter(
        (curation) =>
            ...
            (curation.createdBy && curation.createdBy.toLowerCase().includes(curationSearchTerm.toLowerCase())) ||
                        ...
                        <CardContent>
                            <div className="flex flex-col md:flex-row gap-4">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <Button variant="outline" size="sm" onClick={() => handleSortOrderChange("LIKECOUNT")}>
                                        인기순
                                    </Button>
                                ...
                                {filteredCurations.length > 0 ? (
                                    filteredCurations.map((curation) => (
                                        <TableRow key={curation.id}>
                                            ...
                                            <TableCell>{curation.createdBy || "알 수 없음"}</TableCell>
