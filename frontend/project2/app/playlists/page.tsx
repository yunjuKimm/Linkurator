    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">나만의 링크 큐레이션을 관리하세요.</p>
        </div>
      ...
      {playlists.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {playlists.map((playlist) => (
            <div key={playlist.id} className="border rounded-lg overflow-hidden shadow hover:shadow-lg transition">
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-500">{new Date(playlist.createdAt).toLocaleDateString("ko-KR")}</p>
                ...
                <div className="mt-4 flex justify-between">
                  ...
                  <Link href={`/playlists/${playlist.id}/items/link`}>
                    <button className="text-sm text-green-600 hover:underline">링크 추가</button>
                  </Link>
                </div>
              </div>
            </div>
